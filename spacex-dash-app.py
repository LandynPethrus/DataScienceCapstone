...
html.Br(),
    ...
    dcc.RangeSlider(id='payload-slider',
                    ...
                    max=max_payload,
                    step=1000,
                    marks={int(i): str(i) for i in range(int(min_payload), int(max_payload)+1, 2500)},
...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        # Group by LaunchSite and count successful launches (Class == 1)
...
def get_scatter_plot(entered_site, payload_range):
    # Filter by payload range using direct indexing
